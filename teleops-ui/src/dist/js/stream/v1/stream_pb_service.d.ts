...
import * as proto_stream_v1_stream_pb from "./stream_pb";
...
type StreamServiceRemoveStream = {
  ...
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof proto_stream_v1_stream_pb.RemoveStreamRequest;
  readonly responseType: typeof proto_stream_v1_stream_pb.RemoveStreamResponse;
};
...
export class StreamServiceClient {
  ...
  removeStream(
    requestMessage: proto_stream_v1_stream_pb.RemoveStreamRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: proto_stream_v1_stream_pb.RemoveStreamResponse|null) => void
  ): UnaryResponse;
  removeStream(
    requestMessage: proto_stream_v1_stream_pb.RemoveStreamRequest,
    callback: (error: ServiceError|null, responseMessage: proto_stream_v1_stream_pb.RemoveStreamResponse|null) => void
